...
export function getFinanceCategories(type: FinanceEntryType) {
    return [...FINANCE_CATEGORIES[type]]
}

export function getDefaultFinanceCategory(type: FinanceEntryType) {
    return FINANCE_CATEGORIES[type][0]
}

export function isValidFinanceCategory(type: FinanceEntryType, category: string) {
